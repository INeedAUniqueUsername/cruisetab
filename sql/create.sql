...
CREATE TABLE Cruise
(
	cnum INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
	rnum INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
	ciid INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
	rid INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
