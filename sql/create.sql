...
CREATE SEQUENCE captain_seq START WITH 1;

DROP SEQUENCE IF EXISTS cruise_seq;
CREATE SEQUENCE cruise_seq START WITH 1;
...
CREATE SEQUENCE cruise_info_seq START WITH 1;

DROP SEQUENCE IF EXISTS repair_seq;
CREATE SEQUENCE repair_seq START WITH 1;
