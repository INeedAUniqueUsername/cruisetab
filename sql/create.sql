...
CREATE SEQUENCE customer_seq START WITH 100000;

DROP SEQUENCE IF EXISTS captain_seq;
CREATE SEQUENCE captain_seq START WITH 100000;

DROP SEQUENCE IF EXISTS cruise_seq;
CREATE SEQUENCE cruise_seq START WITH 100000;

DROP SEQUENCE IF EXISTS ship_seq;
CREATE SEQUENCE ship_seq START WITH 100000;

DROP SEQUENCE IF EXISTS customer_seq;
CREATE SEQUENCE customer_seq START WITH 100000;

DROP SEQUENCE IF EXISTS reservation_seq;
CREATE SEQUENCE reservation_seq START WITH 100000;

DROP SEQUENCE IF EXISTS cruise_info_seq;
CREATE SEQUENCE cruise_info_seq START WITH 100000;

DROP SEQUENCE IF EXISTS repair_seq;
CREATE SEQUENCE repair_seq START WITH 100000;

DROP SEQUENCE IF EXISTS schedule_seq;
CREATE SEQUENCE schedule_seq START WITH 100000;
